              ...
              <form method="POST"  enctype="multipart/form-data">
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-6">
                    ...
                    <!-- HTML code -->
<select class="form-control" name="pay_method" onchange="showQRCode()">
    <option value="cash" selected>Cash</option>
    <option value="esewa">eSewa</option>
</select>

<div id="qr-popup" style="display:none">
<img src="https://media.istockphoto.com/id/828088276/vector/qr-code-illustration.jpg?s=1024x1024&w=is&k=20&c=J3NoWzg4Y5x8x8tPjB-oscJ48ITem2axmKcX5lMusSU=" alt="QR Code" height="200px" width="200px">
...
<script>
function showQRCode() {
    var selectBox = document.getElementsByName("pay_method")[0];
